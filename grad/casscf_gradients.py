"""
Taken as an implementation from pyscf

Analytical MCSCF Energy Gradients: Treatment of Symmetry and
CASSCF Applications to Propadienone
Taylor, J. Comput. Chem. Vol 5. Iss. 6 pg. 589 (1984)
"""
import inspect
import time
...
def grad_elec_ncr(mo_coeff, mol, ncore, ncas, casdm1, casdm2, ci=None, atmlst=None, verbose=None):
    nocc = ncore + ncas
